...
$c_Lcalculator_Calculator$.prototype.loop$1__p1__Lcalculator_Expr__sci_Map__sci_Set__D = (function(expr, references, names) {
  _loop: while (true) {
    var x1 = expr;
    if ($is_Lcalculator_Literal(x1)) {
      ...
      if (names.contains__O__Z(x3.name$2)) {
        return (NaN)
      } else {
        var temp$expr = this.getReferenceExpr__p1__T__sci_Map__Lcalculator_Expr(x3.name$2, references);
        var temp$names = $as_sci_Set(names.$$plus__O__sc_Set(x3.name$2));
        expr = temp$expr;
        names = temp$names;
        continue _loop
      }
      ...
      return (this.loop$1__p1__Lcalculator_Expr__sci_Map__sci_Set__D(x4.a$2, references, names) + this.loop$1__p1__Lcalculator_Expr__sci_Map__sci_Set__D(x4.b$2, references, names))
    } else if ($is_Lcalculator_Minus(x1)) {
      var x5 = $as_Lcalculator_Minus(x1);
      return (this.loop$1__p1__Lcalculator_Expr__sci_Map__sci_Set__D(x5.a$2, references, names) - this.loop$1__p1__Lcalculator_Expr__sci_Map__sci_Set__D(x5.b$2, references, names))
    } else if ($is_Lcalculator_Times(x1)) {
      var x6 = $as_Lcalculator_Times(x1);
      return (this.loop$1__p1__Lcalculator_Expr__sci_Map__sci_Set__D(x6.a$2, references, names) * this.loop$1__p1__Lcalculator_Expr__sci_Map__sci_Set__D(x6.b$2, references, names))
    } else if ($is_Lcalculator_Divide(x1)) {
      var x7 = $as_Lcalculator_Divide(x1);
      return (this.loop$1__p1__Lcalculator_Expr__sci_Map__sci_Set__D(x7.a$2, references, names) / this.loop$1__p1__Lcalculator_Expr__sci_Map__sci_Set__D(x7.b$2, references, names))
    } else {
      throw new $c_s_MatchError().init___O(x1)
    }
  }
...
$c_Lcalculator_Polynomial$.prototype.computeSolutions__Lcalculator_Signal__Lcalculator_Signal__Lcalculator_Signal__Lcalculator_Signal__Lcalculator_Signal = (function(a, b, c, delta) {
  $m_Lcalculator_Signal$();
  var expr = new $c_sjsr_AnonFunction0().init___sjs_js_Function0((function(a$2, b$2, c$2, delta$1) {
    return (function() {
      if (($uD(a$2.apply__O()) === 0)) {
        var array = [((-$uD(b$2.apply__O())) / $uD(c$2.apply__O()))];
        ...
        var array$1 = [(((-$uD(b$2.apply__O())) / 2) / $uD(a$2.apply__O()))];
        ...
        var jsx$6 = $uD(b$2.apply__O());
        var a$1 = $uD(delta$1.apply__O());
        var jsx$5 = $uD($g.Math.sqrt(a$1));
        var jsx$4 = $uD(a$2.apply__O());
        var jsx$3 = $uD(b$2.apply__O());
        var a$3 = $uD(delta$1.apply__O());
        var array$2 = [((((-jsx$6) + jsx$5) / 2) / jsx$4), ((((-jsx$3) - $uD($g.Math.sqrt(a$3))) / 2) / $uD(a$2.apply__O()))];
        if (($uI(array$2.length) === 0)) {
          ...
          while ((i$2 < len$2)) {
            ...
            b$4.$$plus$eq__O__scm_SetBuilder(arg1$2);
            i$2 = ((1 + i$2) | 0)
          };
          var jsx$7 = b$4.elems$1
        };
        return $as_sci_Set(jsx$7)
      }
    })
  })(a, b, c, delta));
  return new $c_Lcalculator_Signal().init___F0(expr)
...
$c_Lcalculator_Calculator$$anonfun$computeValues$1.prototype.apply__Lcalculator_Signal__Lcalculator_Signal = (function(expr) {
  $m_Lcalculator_Signal$();
  var expr$3 = new $c_sjsr_AnonFunction0().init___sjs_js_Function0((function(arg$outer, expr$1) {
    return (function() {
      var this$1 = $m_Lcalculator_Calculator$();
      var expr$2 = $as_Lcalculator_Expr(expr$1.apply__O());
      var references = arg$outer.namedExpressions$1$f;
      return this$1.loop$1__p1__Lcalculator_Expr__sci_Map__sci_Set__D(expr$2, references, $as_sci_Set($m_s_Predef$().Set$2.apply__sc_Seq__sc_GenTraversable($m_sci_Nil$())))
    })
  })(this, expr));
  return new $c_Lcalculator_Signal().init___F0(expr$3)
});
